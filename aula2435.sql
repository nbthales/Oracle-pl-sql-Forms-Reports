...
--command window
SQL> execute grava_estoque(24,'Video Aula Apple','un',80,'19/06/2009');
SQL> execute grava_estoque(24,'Video Aula Apple','un',200,'19/06/2009');
SQL> execute grava_estoque(24,'Video Aula Apple','un',180,'19/06/2009');
